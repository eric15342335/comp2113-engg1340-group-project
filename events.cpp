...
std::vector<Stock_event> all_stock_events = {
    ...
    {/** event_id */ 0,
     ...
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.1}, {mean, 20}, {lower_limit, 0}, {upper_limit, 20}}},
    {/** event_id */ 1,
     ...
     /** type_of_event */ all_stocks,
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.1}, {mean, -20}, {lower_limit, -20}, {upper_limit, 0}}},
    {/** event_id */ 2,
     ...
     /** type_of_event */ all_stocks,
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.2}, {mean, -50}, {lower_limit, -50}, {upper_limit, 0}}},
    {/** event_id */ 3,
     /** mutually_exclusive_events */ {1},
     ...
     /** type_of_event */ all_stocks,
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.05}, {mean, 10}, {lower_limit, 0}, {upper_limit, 10}}},
    {/** event_id */ 4,
     /** mutually_exclusive_events */ {},
     ...
     /** type_of_event */ all_stocks,
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.15}, {mean, -30}, {lower_limit, -30}, {upper_limit, 0}}},
    {/** event_id */ 5,
     /** mutually_exclusive_events */ {},
    ...
    {/** event_id */ 6,
     ...
     /** type_of_event */ all_stocks,
     /** category */ 0,
     /** modifiers*/ {{standard_deviation, 0.08}, {mean, -10}, {lower_limit, -15}, {upper_limit, 5}}},
    {/** event_id */ 7,
     /** mutually_exclusive_events */ {},
